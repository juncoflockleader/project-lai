...
衣服同理，而且这里最容易偷懒：**把躯干换个颜色不算穿衣服**，那还是极简。
衣服得是几件分开的东西 —— 袍子、下摆、袖子、腰带、领口，各是各的几何体，
接缝看得见，腰带还歪三度。判断方法一样：这是"没穿衣服"，还是"穿了但做成这样"。

还有一条，是做蛇精的尖下巴时撞出来的：**改轮廓要换掉原来的形体，光加零件没用。**
在圆头底下再粘一个锥子，球还在那儿，比锥子宽，轮廓照样是圆的，加了等于没加。
要尖下巴就得把天灵盖压扁、下半张脸整个换成锥子。加零件能改细节，改不了剪影。

另外零件做出来还得**露得出来**。默认头底在袍子肩线以下，下颌本来就埋在衣服里，
尖头再尖也是尖在领子内部 —— 得先把头抬起来。做完先渲一张特写看，别只看代码。
